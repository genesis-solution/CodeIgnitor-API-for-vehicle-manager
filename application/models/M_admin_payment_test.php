...
class M_admin_payment_test extends CI_Model {
    ...
    function __construct()
    {
        ...
        $config['hostname'] = "chatterboss.cmn5mtvqzban.us-west-2.rds.amazonaws.com:3306";
        $config['username'] = "boss_admin";
        $config['password'] = "chatterboss_55#";
        $config['database'] = "chatterboss_payment_test_2_0";
